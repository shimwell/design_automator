...
with open("README.md", "w") as readme:
    ...
    readme.write("|---|---|---|\n")
    readme.write(f'| blanket offset from source | {latest_design["blanket_offset_from_source"]} | m |\n')
    readme.write(f'| blanket thickness | {latest_design["blanket_thickness"]} | m |\n')
    readme.write(f'| vessel offset from blanket |{latest_design["vessel_offset_from_blanket"]} | m |\n')
    readme.write(f'| blanket material | {latest_design["blanket_material"]} | |\n')
    readme.write(f'| blanket Li6 enrichment | {latest_design["blanket_li6_enrichment"]} | percent |\n')
    readme.write("\n")
    ...
    readme.write(
        f'| Weight of vacuum vessel | {op} {val}kg | {latest_design["weight_of_vessel"]} | [![vessel weight requirement](https://github.com/shimwell/design_automator/actions/workflows/requirement_vessel_weight.yml/badge.svg)](https://github.com/shimwell/design_automator/actions/workflows/requirement_vessel_weight.yml) |\n'
    )

    op = requirements["radius_of_vessel"][0][0].__name__
    val = requirements["radius_of_vessel"][0][1]
    readme.write(
        f'| Radius of vessel | {op} {val}m | {latest_design["radius_of_vessel"]} | [![radius requirement](https://github.com/shimwell/design_automator/actions/workflows/requirements_radius.yml/badge.svg)](https://github.com/shimwell/design_automator/actions/workflows/requirements_radius.yml) \n'
    )
    ...
    readme.write(
        f'| Tritium breeding Ratio | {op} {val} | {latest_design["tritium_breeding_ratio"]} | [![TBR requirements](https://github.com/shimwell/design_automator/actions/workflows/requirements_tbr.yml/badge.svg)](https://github.com/shimwell/design_automator/actions/workflows/requirements_tbr.yml) |\n'
    )
    ...
    readme.write("\n")
    readme.write("# Improvement tracking")

    readme.write("![parameters](./improvement_tritium_breeding_ratio.png)\n")
    readme.write("![parameters](./improvement_radius_of_vessel.png)\n")
    readme.write("![parameters](./improvement_weight_of_vessel.png)\n")
